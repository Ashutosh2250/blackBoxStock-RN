...
class CustomSwitch extends Component {
    static defaultProps = {
        ...
        circleStyle: {
            ...
            borderRadius: widthScale(24 / 2),
            backgroundColorOn: colors.APP_GREEN
        },
        backgroundColorOn: "rgba(110,210,90,0.3)",
        backgroundColorOff: 'grey',
        circleColorOff: 'white',
        circleColorOn: "rgba(110,210,90,1)",
        duration: 100,
    };
